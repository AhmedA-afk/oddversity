...
risk = likelihood * impact; k_anonymity = minimum_number_sharing_quasi_identifier_pattern
...
Classify data, enforce tenant filters before retrieval, test prompt injection, redact logs, rotate secrets, and rehearse breach response.
