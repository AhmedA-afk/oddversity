...
order: 225
status: live
summary: "Use causal structure to distinguish association from the effect of changing a system."
...
If a seasonal factor influences both ice-cream sales and sunburn, observing sales does not imply changing sales changes sunburn. A causal graph represents the common cause.
...
A directed edge should be defended by domain knowledge and design assumptions. Causal language is not licensed by correlation alone.
