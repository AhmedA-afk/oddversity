...
fusion_score = sum_m reliability_m * evidence_m / sum_m reliability_m
...
Create modality-specific baselines, test missing and conflicting inputs, record provenance, and provide a unimodal safe fallback.
