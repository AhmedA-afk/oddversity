...
Build a configuration-space sketch, trace collision checks, and add safety margins, replanning triggers, and a stop condition. Submit a concise technical notebook or report containing: (1) a formal problem statement; (2) one fully shown trace or calculation; (3) executable pseudocode or code; (4) three scenario analyses; (5) a failure test; and (6) a decision log or assurance argument.
