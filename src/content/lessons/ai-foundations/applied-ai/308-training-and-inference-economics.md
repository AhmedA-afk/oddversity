...
monthly_cost = fixed_training_cost/amortization_months + requests * (input_tokens*input_price + output_tokens*output_price)
...
Calculate p50/p95 latency, cost per completed task, fallback rate, and the quality-cost frontier for at least three model choices.
