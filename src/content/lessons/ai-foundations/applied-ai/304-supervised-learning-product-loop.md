...
expected_loss = c_fp * FP + c_fn * FN + c_review * reviewed
...
Define the label policy, a time-respecting split, calibration requirement, and an escalation band before fitting.
