...
go_no_go = weighted_quality >= target AND critical_harm_rate <= limit AND cost_per_task <= budget
...
Produce a model card, data card, risk register, evaluation report, release checklist, and change-control procedure.
