...
silhouette = (mean_intercluster_distance - mean_intracluster_distance) / max(mean_intercluster_distance, mean_intracluster_distance)
...
Run stability checks across seeds and periods, inspect representatives with domain experts, and forbid consequential action from an unvalidated cluster.
