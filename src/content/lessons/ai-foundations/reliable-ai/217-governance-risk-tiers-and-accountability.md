...
order: 217
status: live
summary: "A rigorous, practice-led lesson on roles, approval gates, documentation, decision rights, and proportional controls for building AI systems that can be evaluated, challenged, and operated responsibly."
duration: "50–70 min"
updated: "2026-08-30"
---

# Governance, Risk Tiers, and Accountability
...
available when a decision is made. This lesson examines **roles, approval gates, documentation, decision rights, and proportional controls**. The goal is not to
...
metric misleading here?** In this unit, the relevant mechanism is roles, approval gates, documentation, decision rights, and proportional controls. Treat it
...
For governance, risk tiers, and accountability, use the same discipline with the relevant signals:
risk classification accuracy, gate completion, owner assignment, exception age, and audit trail quality. Estimate uncertainty rather than treating one run as final. For a proportion,
...
Consider a hospital deploys a low-risk drafting tool and a high-impact triage tool under one process. Begin with a narrow workflow map: who supplies an input, what
...
The characteristic failure to avoid is **treating governance as a final compliance form rather than operational decision design**. It often survives a dashboard
...
4. Compute risk classification accuracy, gate completion, owner assignment, exception age, and audit trail quality; publish slice counts and uncertainty.
...
## Model cards and accountable governance

Governance needs an artifact that connects a high-level approval to falsifiable
operational evidence. A model card should name the intended and prohibited uses,
dataset provenance, evaluation protocol, key slices, calibration or threshold policy,
known failure modes, privacy and security controls, owner, version, and review date.
It is not a marketing sheet: an unsupported claim belongs in the limitations section
or should be removed.

Risk tiering determines how much independent challenge is required. A low-impact
autocomplete tool may need routine monitoring and a clear owner; a system influencing
medical, employment, credit, education, or public-service decisions requires stronger
documentation, human authority, incident rehearsals, and an evidence-backed approval.
Every exception should be time-bounded, signed by an accountable role, and revisited
when the data, model, purpose, or operating environment materially changes.
