...
order: 224
status: live
summary: "Decide whether another test, question, or inspection is worth its cost before collecting it."
...
If a test raises the best achievable expected utility from 4.4 to 5.1 and costs 0.3, its net value is 0.4 under the stated model. Value depends on the action the information can change.
...
More data can increase delay, privacy risk, and opportunity for bias. Do not collect information merely because it is available.
