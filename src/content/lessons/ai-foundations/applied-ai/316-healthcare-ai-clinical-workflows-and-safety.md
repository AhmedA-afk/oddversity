...
net_benefit = true_positive_rate - false_positive_rate * threshold_odds
...
Map intended use, excluded populations, clinical review, dataset shift risk, privacy controls, and a silent-mode prospective study.
