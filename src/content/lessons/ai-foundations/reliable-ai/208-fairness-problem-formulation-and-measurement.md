...
order: 208
status: live
summary: "A rigorous, practice-led lesson on stakeholder-defined harms, group metrics, intersectional analysis, and trade-offs for building AI systems that can be evaluated, challenged, and operated responsibly."
duration: "50–70 min"
updated: "2026-08-30"
---

# Fairness: Problem Formulation and Measurement
...
available when a decision is made. This lesson examines **stakeholder-defined harms, group metrics, intersectional analysis, and trade-offs**. The goal is not to
...
metric misleading here?** In this unit, the relevant mechanism is stakeholder-defined harms, group metrics, intersectional analysis, and trade-offs. Treat it
...
For fairness: problem formulation and measurement, use the same discipline with the relevant signals:
selection rate, false-positive/negative rates, calibration by group, and uncertainty intervals. Estimate uncertainty rather than treating one run as final. For a proportion,
...
Consider a hiring screen with equal aggregate accuracy but unequal false-negative rates. Begin with a narrow workflow map: who supplies an input, what
...
The characteristic failure to avoid is **choosing a fairness metric before identifying who bears the error and why**. It often survives a dashboard
...
4. Compute selection rate, false-positive/negative rates, calibration by group, and uncertainty intervals; publish slice counts and uncertainty.
