...
order: 211
status: live
summary: "Work backward from a query when the question is narrow and the knowledge base is large."
...
To answer `eligible(lee)`, select rules whose head is `eligible`, then recursively prove their prerequisites. A proof tree makes every missing premise visible.
...
Naive recursion can loop on cyclic rules. Memoize subgoals and distinguish “not proven” from “proven false.”
