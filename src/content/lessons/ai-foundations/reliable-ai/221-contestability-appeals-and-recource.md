...
order: 221
status: live
summary: "A rigorous, practice-led lesson on explanations for affected people, appeal processes, correction, and accountable recourse for building AI systems that can be evaluated, challenged, and operated responsibly."
duration: "50–70 min"
updated: "2026-08-30"
---

# Contestability, Appeals, and Recourse
...
available when a decision is made. This lesson examines **explanations for affected people, appeal processes, correction, and accountable recourse**. The goal is not to
...
metric misleading here?** In this unit, the relevant mechanism is explanations for affected people, appeal processes, correction, and accountable recourse. Treat it
...
For contestability, appeals, and recourse, use the same discipline with the relevant signals:
appeal accessibility, overturn rate, correction latency, repeat-harm rate, and recourse feasibility. Estimate uncertainty rather than treating one run as final. For a proportion,
...
Consider a student is denied a service by an automated eligibility workflow. Begin with a narrow workflow map: who supplies an input, what
...
The characteristic failure to avoid is **offering a generic explanation when users need a path to challenge and correct a decision**. It often survives a dashboard
...
4. Compute appeal accessibility, overturn rate, correction latency, repeat-harm rate, and recourse feasibility; publish slice counts and uncertainty.
