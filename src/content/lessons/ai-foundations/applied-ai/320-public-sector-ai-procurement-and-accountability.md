...
public_value = service_gain - harm_cost - exclusion_cost - accountability_cost
...
1. **Conservative path.** A benefits-help assistant explains eligibility rules and routes cases. It must not silently determine entitlement or disadvantage people without digital access. Start with a visible recommendation and a trained human owner. Measure decisions before automating. This reveals whether the proposed model changes useful work or merely produces plausible text.
...
Publish intended use, appeal path, procurement clauses, language/accessibility plan, disparate-impact monitoring, and external audit artifacts.
