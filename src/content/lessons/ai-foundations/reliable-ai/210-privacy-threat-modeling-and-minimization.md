...
order: 210
status: live
summary: "A rigorous, practice-led lesson on identifiability, purpose limitation, retention, attack paths, and minimization for building AI systems that can be evaluated, challenged, and operated responsibly."
duration: "50–70 min"
updated: "2026-08-30"
---
...
available when a decision is made. This lesson examines **identifiability, purpose limitation, retention, attack paths, and minimization**. The goal is not to
...
metric misleading here?** In this unit, the relevant mechanism is identifiability, purpose limitation, retention, attack paths, and minimization. Treat it
...
For privacy threat modeling and data minimization, use the same discipline with the relevant signals:
collection rate, retention age, access count, re-identification risk, and deletion completion. Estimate uncertainty rather than treating one run as final. For a proportion,
...
Consider a wellbeing assistant storing free-text messages that contain health and family details. Begin with a narrow workflow map: who supplies an input, what
...
The characteristic failure to avoid is **collecting data because it may be useful without a justified purpose or deletion path**. It often survives a dashboard
...
4. Compute collection rate, retention age, access count, re-identification risk, and deletion completion; publish slice counts and uncertainty.
