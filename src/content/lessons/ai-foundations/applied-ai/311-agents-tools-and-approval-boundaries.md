...
risk_exposure = probability_of_bad_action * impact_of_bad_action; automate_when = saved_effort > expected_loss
...
Define tool schemas, idempotency keys, retry limits, approval gates, sandboxed execution, and a transcript review protocol.
