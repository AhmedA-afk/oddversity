...
lift = mean(outcome_treatment) - mean(outcome_control); ci = lift +/- critical_value * standard_error
...
Specify population, exposure unit, guardrail metrics, stopping rule, power calculation, and how results will change the release decision.
