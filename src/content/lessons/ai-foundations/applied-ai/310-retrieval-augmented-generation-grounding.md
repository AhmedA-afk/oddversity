...
answer_utility = grounded_accuracy - alpha*unsupported_claim_rate - beta*latency
...
Evaluate retrieval recall, citation precision, answer faithfulness, stale-document rate, and abstention correctness independently.
