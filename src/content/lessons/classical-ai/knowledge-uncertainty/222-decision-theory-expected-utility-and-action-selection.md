...
order: 222
status: live
summary: "Choose actions by combining uncertainty with consequences, not by selecting whichever outcome is most likely."
...
If action A yields 10 when success is 0.6 likely and -4 otherwise, its expected utility is `0.6×10 + 0.4×(-4) = 4.4`. Compare that with alternatives under the same utility scale.
...
Expected utility does not make ethical trade-offs objective. The utility model must be governed, reviewed, and sensitive to who bears harm.
