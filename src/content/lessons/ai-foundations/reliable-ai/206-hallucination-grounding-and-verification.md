...
order: 206
status: live
summary: "A rigorous, practice-led lesson on why generative systems fabricate, retrieval boundaries, claim verification, and refusal for building AI systems that can be evaluated, challenged, and operated responsibly."
duration: "50–70 min"
updated: "2026-08-30"
---
...
available when a decision is made. This lesson examines **why generative systems fabricate, retrieval boundaries, claim verification, and refusal**. The goal is not to
...
metric misleading here?** In this unit, the relevant mechanism is why generative systems fabricate, retrieval boundaries, claim verification, and refusal. Treat it
...
For hallucination, grounding, and verification, use the same discipline with the relevant signals:
citation support rate, entailment, retrieval recall, unsupported-claim rate, and refusal quality. Estimate uncertainty rather than treating one run as final. For a proportion,
...
Consider a policy assistant inventing a reimbursement rule and a plausible citation. Begin with a narrow workflow map: who supplies an input, what
...
The characteristic failure to avoid is **calling retrieved text grounding without checking that it supports the generated claim**. It often survives a dashboard
...
4. Compute citation support rate, entailment, retrieval recall, unsupported-claim rate, and refusal quality; publish slice counts and uncertainty.
