...
expected_savings = avoided_failure_cost - false_alarm_cost - inspection_cost - operating_cost
...
Define sensor calibration, labelled inspection protocol, recall at a fixed false-alarm rate, maintenance windows, and operator override.
