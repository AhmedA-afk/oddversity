...
order: 216
status: live
summary: "Calculate how evidence updates uncertainty while stating the prior, likelihood, and independence assumptions."
...
With prior `P(F)=0.01`, sensitivity `P(+|F)=0.90`, and false-positive rate `P(+|¬F)=0.05`, `P(F|+) = 0.009 / (0.009 + 0.0495) ≈ 0.154`. A positive test is not a diagnosis.
...
Base-rate neglect and unjustified independence are common sources of persuasive but incorrect probabilistic reasoning.
