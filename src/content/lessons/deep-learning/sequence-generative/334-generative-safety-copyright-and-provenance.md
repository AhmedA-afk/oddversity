...
track: "deep-learning"
status: live
summary: "Generative capability changes legal, creative, privacy, and misuse risks; controls belong in design, not a final disclaimer."
...
Risk is conditional: $P(harm)=\sum_cP(harm\mid c)P(c)$. Define contexts, affected groups, severity, and who can intervene.
...
A style request may be permitted while a request to reproduce a living artist’s identifiable work needs policy and product judgment; log policy rationale.
...
A model can expose memorized personal data after benign prompting; minimize sensitive data, test extraction, and provide deletion pathways.
...
Provenance metadata can signal tool and model version but cannot prove truth or ownership. Preserve original-source links where available.
...
Red-team tests must include multilingual, indirect, and tool-using prompts. Measure bypass rate and false refusals together.
