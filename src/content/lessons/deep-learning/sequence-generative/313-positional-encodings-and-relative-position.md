...
track: "deep-learning"
status: live
summary: "Self-attention is permutation-equivariant until positions or relations are introduced."
...
Sinusoidal features use $PE_{t,2i}=\sin(t/10000^{2i/d})$ and $PE_{t,2i+1}=\cos(t/10000^{2i/d})$. Dot products encode relative offsets through trigonometric identities.
...
Two identical tokens at positions 2 and 20 need distinguishable representations; add or rotate positional signals before attention.
...
In a genomic sequence, absolute position may matter; in a repeated pattern, relative offset can be more transferable.
...
Extrapolating to longer contexts tests positional design: a table learned only up to 512 positions has no defined embedding at 1,024.
...
Do not conflate token index with real time; irregular timestamps need elapsed-time features too.
