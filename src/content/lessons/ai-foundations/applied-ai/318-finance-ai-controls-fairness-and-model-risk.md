...
expected_credit_loss = probability_of_default * loss_given_default * exposure_at_default
...
Document feature rationale, adverse-action review, temporal stress tests, fairness analysis, override logging, and independent validation.
