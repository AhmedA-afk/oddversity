...
learning_gain = post_assessment - pre_assessment; equity_gap = subgroup_gain_a - subgroup_gain_b
...
Design hint levels, disclosure, teacher controls, accessibility tests, plagiarism boundaries, and an evaluation that measures learning rather than engagement.
