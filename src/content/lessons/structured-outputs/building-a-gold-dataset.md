...
- **Never refreshing it.** A gold set frozen at launch stops reflecting reality the moment your document distribution shifts — a new vendor format, a new locale, a schema version bump. Revisit it on a real cadence (a schema version bump is a reasonable trigger), adding new edge cases as they're discovered in production rather than only at creation time.
