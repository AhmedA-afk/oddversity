...
weighted_score = sum_i severity_i * pass_i / sum_i severity_i
...
Write annotation guidelines, sample rare harms deliberately, measure agreement, calibrate reviewers, and audit disagreement patterns.
