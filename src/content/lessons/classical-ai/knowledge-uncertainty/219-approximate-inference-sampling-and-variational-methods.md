...
order: 219
status: live
summary: "Estimate beliefs when exact inference is too expensive, and communicate approximation error rather than presenting a single number as exact."
...
A Monte Carlo estimate averages an indicator: if 154 of 1,000 weighted samples support a hypothesis, the raw estimate is 0.154 before assessing effective sample size.
...
Low-variance-looking samples can still be biased by a poor proposal or an overly restrictive variational family.
