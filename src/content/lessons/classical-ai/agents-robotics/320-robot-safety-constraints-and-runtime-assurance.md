...
Implement independent monitors, speed zones, geofences, emergency stop, watchdog timers, and auditable overrides. Build the following interfaces even in a small prototype:
