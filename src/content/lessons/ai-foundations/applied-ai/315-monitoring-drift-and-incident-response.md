...
psi = sum_bins (actual_i - expected_i) * ln(actual_i/expected_i)
...
Set alert thresholds, owner rotation, rollback criteria, diagnostic slices, retraining approval steps, and a post-incident learning record.
