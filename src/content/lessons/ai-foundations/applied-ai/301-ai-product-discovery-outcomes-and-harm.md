...
expected_value = volume * (benefit_per_correct * p_correct - cost_per_harm * p_harm) - operating_cost
...
Interview decision owners, map the current workflow, name the action the system may take, and write a non-automation alternative.
